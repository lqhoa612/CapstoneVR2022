...
namespace RosMessageTypes.HoaUnityRos
{
    ...
    {
        public const string k_RosMessageName = "hoa_unity_ros/MoverService";
        public override string RosMessageName => k_RosMessageName;

        public UR3MoveitJointsMsg joints_input;
        public Geometry.PoseMsg pick_pose;
        public Geometry.PoseMsg place_pose;

        public MoverServiceRequest()
        {
            this.joints_input = new UR3MoveitJointsMsg();
            this.pick_pose = new Geometry.PoseMsg();
            this.place_pose = new Geometry.PoseMsg();
        }

        public MoverServiceRequest(UR3MoveitJointsMsg joints_input, Geometry.PoseMsg pick_pose, Geometry.PoseMsg place_pose)
        {
        ...
        {
            this.joints_input = UR3MoveitJointsMsg.Deserialize(deserializer);
